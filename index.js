...
app.get('/api/auth', function (request, response, next) {
  Promise.resolve()
    .then(async function () {
      ...
      // account_name = res.accounts[0].official_name
      // balance = 1100
      // ach_account = res.numbers.ach[0].account 
      // ach_routing = res.numbers.ach[0].routing
      // iso_currency_code = "usd"
      // console.log(account_name, balance, ach_account, ach_routing, iso_currency_code)
    })
    .catch(next);
});
